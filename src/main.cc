...
int main(int argc, char** argv)
{
    ...
    cout << "L1I sets: " << L1I_SET << endl;
    cout << "L1I ways: " << L1I_WAY << endl;
    ...
    for (int i=0; i<NUM_CPUS; i++) {
        ...
        ooo_cpu[i].L1I.l1i_initialize_replacement();
    ...
    //uncore.L1I.l1i_initialize_replacement();
    ...
    for (uint32_t i=0; i<NUM_CPUS; i++) {
        ooo_cpu[i].L1I.l1i_replacement_final_stats();
        ooo_cpu[i].L1D.l1d_prefetcher_final_stats();
        ooo_cpu[i].L2C.l2c_prefetcher_final_stats();
    }
